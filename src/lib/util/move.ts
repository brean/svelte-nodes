// move elements around to change their x and y / left and top positions.
...
export default class MoveManager {
  ...
  // The visual DOM-Element that is being moved by the pointer
  private moveDOM?: any;

  // The data of the element we move around, IElement or IGroup instance
  private moveData?: INode | IGroup;
  ...
  private graph: IGroup;
  private rootGroup?: SVGElement;
  public placeholder?: any;

  constructor(graph: IGroup) {
    this.graph = graph;
  }
  ...
  onPointerMove(e: any) {
    // Move element
    // TODO: Highlight the parent while moving if we move from one group
    // onto another.
